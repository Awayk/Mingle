  ...
  <div class="d-flex flex-row justify-content-end">
    <div class="container mr-auto">
      <nav class="navbar navbar-expand-lg py-0" id="navBar">
        <a class="navbar-brand" href="#"><img class="img-responsive" width="45" height="40" src="../public/img/MLetterLogo.png" alt="Mingle"></a>
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbar-dropdown">
                <a class="dropdown-item" href="#">Silbernetz</a>
...
>>>>>>> 5c2526b536bcec716dedf7a23f4b5f157a9f4b1e
        </div>
      </div>
    </div>
  </div>
