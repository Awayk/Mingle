<section id="footerSection">
  <div class="container mt-3">
    <div class="row justify-content-md-center">
      <div class="col-xl-2 col-lg-3 col-md-3 col-sm-4 col-xs-3">
        <ul>
          <h6 id="footerHeader">Support</h6><br>
          <a href="#" id="footerLink">Chat</a><br>
          <a href="#" id="footerLink">Contact</a><br>
          <a href="#" id="footerLink">FAQ</a><br>
          <a href="#" id="footerLink">Forum</a>
        </ul>
      </div>
      <div class="col-xl-2 col-lg-3 col-md-3 col-sm-4 col-xs-3">
        <ul>
          <h6 id="footerHeader">About</h6><br>
          <a href="#" id="footerLink">Impressum</a><br>
          <a href="#" id="footerLink">Directions</a><br>
          <a href="#" id="footerLink">Legal</a>
        </ul>
      </div>
      <div class="col-xl-2 col-lg-3 col-md-3 col-sm-4 col-xs-3">
        <ul>
  ...
  <div class="container-fluid" id="copyrightContainer">
  <div class="row justify-content-center">
    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-7 col-xs-5 text-center">
